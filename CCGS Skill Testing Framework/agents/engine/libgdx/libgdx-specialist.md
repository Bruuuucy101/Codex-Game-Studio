# libgdx-specialist — behavioral specification

Source: `.claude/agents/libgdx-specialist.md`. Run with the full canonical body and runtime
...
**Input:** Configure Java desktop/headless; route Stage, FBO, Ashley and AssetManager questions.

**Expected:** Reads pins and chosen backends, delegates all four real specialists with bounded scopes and required evidence; no invented role or automatic optional dependency.
