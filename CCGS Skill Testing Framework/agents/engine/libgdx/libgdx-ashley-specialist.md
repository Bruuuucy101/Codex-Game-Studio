# libgdx-ashley-specialist — behavioral specification

Source: `.claude/agents/libgdx-ashley-specialist.md`. Run with the full canonical body and runtime
...
**Input:** Destroy Box2D bodies in a contact listener and keep pooled component references between entities.

**Expected:** Checks selected dependency pins, queues unsafe World mutations after step, rejects stale pooled ownership and requires actual ECS/native tests.
