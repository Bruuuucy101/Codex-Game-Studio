# libgdx-graphics-specialist — behavioral specification

Source: `.claude/agents/libgdx-graphics-specialist.md`. Run with the full canonical body and runtime
...
**Input:** Resize an FBO then render translucent sprites; propose pooling all allocations as proof of performance.

**Expected:** Checks framebuffer/viewport restoration, attachment ownership, painter order and measured frame/GPU evidence; no blanket pooling or headless GPU claim.
