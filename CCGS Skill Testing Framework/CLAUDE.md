...
| File | Purpose |
|------|---------|
| `catalog.yaml` | Master registry for all 74 skills and 52 agents (73 original skills and 49 original agents retained). Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. |
