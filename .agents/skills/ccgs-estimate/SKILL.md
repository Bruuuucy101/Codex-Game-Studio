...
# CCGS Codex entry: estimate

Source: `.claude/skills/estimate/SKILL.md` (relative to the project root).
SHA256: `7774e2d256a054a215cf62cc81d4d79f4d18e2154203671a39f643c0881be5fd`
Original metadata: {"name": "estimate", "description": "Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels.", "argument-hint": "[task-description]", "user-invocable": "true", "allowed-tools": "Read, Glob, Grep", "model": "sonnet"}
...
3. Read the COMPLETE `.claude/skills/estimate/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
