...
# CCGS Codex entry: team-polish

Source: `.claude/skills/team-polish/SKILL.md` (relative to the project root).
SHA256: `fb4d48c5bd8f2563d6f999bea940929a20b8c52ed797b306a999e2b4d5596d26`
Original metadata: {"name": "team-polish", "description": "Orchestrate the polish team: coordinates performance-analyst, technical-artist, sound-designer, and qa-tester to optimize, polish, and harden a feature or area for release quality.", "argument-hint": "[feature or area to polish] [--review full|lean|solo]", "user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task, AskUserQuestion, TodoWrite", "model": "sonnet"}
...
3. Read the COMPLETE `.claude/skills/team-polish/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
