...
# CCGS Codex entry: team-ui

Source: `.claude/skills/team-ui/SKILL.md` (relative to the project root).
SHA256: `d8aa30cbc82c40f3ec53ebceaf229243cac1bc14126ea56f5bfcf57b3c81d0bf`
Original metadata: {"name": "team-ui", "description": "Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design, implementation, review, and polish. Integrates with /ux-design, /ux-review, and studio UX templates.", "argument-hint": "[UI feature description] [--review full|lean|solo]", "user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task, AskUserQuestion, TodoWrite", "model": "sonnet"}
...
3. Read the COMPLETE `.claude/skills/team-ui/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
