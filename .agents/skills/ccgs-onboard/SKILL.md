...
# CCGS Codex entry: onboard

Source: `.claude/skills/onboard/SKILL.md` (relative to the project root).
SHA256: `fbf7f691226e4c5fccbfa40423d61d123f3e0088d36b719663cca40e96a5d6d7`
Original metadata: {"name": "onboard", "description": "Generates a contextual onboarding document for a new contributor or agent joining the project. Summarizes project state, architecture, conventions, and current priorities relevant to the specified role or area.", "argument-hint": "[role|area]", "user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write", "model": "haiku"}
...
3. Read the COMPLETE `.claude/skills/onboard/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
