...
# CCGS Codex entry: retrospective

Source: `.claude/skills/retrospective/SKILL.md` (relative to the project root).
SHA256: `60f9525887c94e4cf8239de3a2078389e6d6b19dd9f10705772490650c11ffda`
Original metadata: {"name": "retrospective", "description": "Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration.", "argument-hint": "[sprint-N|milestone-name]", "user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Bash, AskUserQuestion", "model": "sonnet"}
...
3. Read the COMPLETE `.claude/skills/retrospective/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
