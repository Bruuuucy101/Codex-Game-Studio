...
3. Read the COMPLETE `.claude/skills/team-narrative/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
