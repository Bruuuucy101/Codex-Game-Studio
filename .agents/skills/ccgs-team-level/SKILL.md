...
# CCGS Codex entry: team-level

Source: `.claude/skills/team-level/SKILL.md` (relative to the project root).
SHA256: `2035d20d9393f6e703e04074ded2145688a8e2e4a2191f5a75866a4fb97100bd`
Original metadata: {"name": "team-level", "description": "Orchestrate level design team: level-designer + narrative-director + world-builder + art-director + systems-designer + qa-tester for complete area/level creation.", "argument-hint": "[level name or area to design] [--review full|lean|solo]", "user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task, AskUserQuestion, TodoWrite", "model": "sonnet"}
...
3. Read the COMPLETE `.claude/skills/team-level/SKILL.md` workflow, in chunks if needed; do not execute from this entry or description alone. Read its required references and matched rules. This entry is not a condensed replacement.
