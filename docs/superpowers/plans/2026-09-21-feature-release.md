...
- [ ] Update both quickstarts with setup-tool, scaffold-web and scaffold-libgdx usage, exact runtime prerequisites and safe preview/write semantics. Keep board-sync explicitly deferred and state no mobile/Kotlin/WebGPU/provider execution unless actual receipt proves it. Keep full/lean/solo and all original capabilities discoverable.
