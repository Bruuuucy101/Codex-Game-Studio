...
Official source context: [tagged package](https://raw.githubusercontent.com/mrdoob/three.js/r186/package.json). Application architecture here is a studio convention.
